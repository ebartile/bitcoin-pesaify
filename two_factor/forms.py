...
class AuthenticationTokenForm(OTPAuthenticationFormMixin, Form):
    otp_token = forms.IntegerField(label=_("Token"), min_value=1,
                                   max_value=int('9' * totp_digits()), widget=forms.NumberInput(attrs={'class': 'form-control'}))
...
class BackupTokenForm(AuthenticationTokenForm):
    otp_token = forms.CharField(label=_("Token"), widget=forms.TextInput(attrs={'class': 'form-control'}))
