...
#
# This python file contains utility scripts to manage music translations.
# It has to be run inside the music-back git root directory.
#
# The following commands are available:
#
# * update_catalogs: check for new strings in music-back catalogs, and
...
#
#  $ python scripts/manage_translations.py lang_stats --language=es --resources=music
...
def update_catalogs(resources=None, languages=None):
    ...
    os.chdir(os.getcwd())
    print("Updating en catalogs for all music-back resourcess...")
    cmd.handle(**opts)
...
def lang_stats(resources=None, languages=None):
    ...
    limit the output (e.g. ['main', 'music']).
    """
...
You need transifex-client, install it.
 ...
 2. Create ~/.transifexrc file:
    ...
    parser = ArgumentParser(description="manage translations in music-back between the repo and transifex.",
